...
Vector3D.ZERO = const3d.ZERO;
Vector3D.LEFT = const3d.LEFT;
Vector3D.RIGHT = const3d.RIGHT;
Vector3D.DOWN = const3d.DOWN;
Vector3D.UP = const3d.UP;
Vector3D.BACK = const3d.BACK;
Vector3D.FORWARD = const3d.FORWARD;
Vector3D.FORWARD_DOWN = const3d.FORWARD_DOWN;
Vector3D.FORWARD_LEFT = const3d.FORWARD_LEFT;
Vector3D.FORWARD_RIGHT = const3d.FORWARD_RIGHT;
Vector3D.FORWARD_UP = const3d.FORWARD_UP;
Vector3D.LEFT_BACK = const3d.LEFT_BACK;
Vector3D.LEFT_DOWN = const3d.LEFT_DOWN;
Vector3D.LEFT_FORWARD = _a.FORWARD_LEFT;
Vector3D.LEFT_UP = const3d.LEFT_UP;
Vector3D.RIGHT_DOWN = const3d.RIGHT_DOWN;
Vector3D.RIGHT_UP = const3d.RIGHT_UP;
Vector3D.RIGHT_BACK = const3d.RIGHT_BACK;
Vector3D.RIGHT_FORWARD = _a.FORWARD_RIGHT;
Vector3D.BACK_DOWN = const3d.BACK_DOWN;
Vector3D.BACK_LEFT = _a.LEFT_BACK;
Vector3D.BACK_RIGHT = _a.RIGHT_BACK;
Vector3D.BACK_UP = const3d.BACK_UP;
...
Vector3D.LEFT_DOWN_BACK = const3d.LEFT_DOWN_BACK;
Vector3D.LEFT_DOWN_FORWARD = const3d.LEFT_DOWN_FORWARD;
Vector3D.LEFT_UP_BACK = const3d.LEFT_UP_BACK;
Vector3D.LEFT_UP_FORWARD = const3d.LEFT_UP_FORWARD;
...
Vector3D.RIGHT_DOWN_BACK = const3d.RIGHT_DOWN_BACK;
Vector3D.RIGHT_DOWN_FORWARD = const3d.RIGHT_DOWN_FORWARD;
Vector3D.RIGHT_UP_BACK = const3d.RIGHT_UP_BACK;
Vector3D.RIGHT_UP_FORWARD = const3d.RIGHT_UP_FORWARD;
