...
export default class Dot3D {
    ...
    distance(d2) { return Dot3D.distance(this, d2); }
    vector(start = Vector3D.ZERO) { return Dot3D.vector(this, start); }
    static distance({ x: x1 = 0, y: y1 = 0, z: z1 = 0 }, { x: x2 = 0, y: y2 = 0, z: z2 = 0 }) { return Math.hypot(x1 - x2, y1 - y2, z1 - z2); }
    static vector({ x = 0, y = 0, z = 0 }, { x: x0, y: y0, z: z0 } = Vector3D.ZERO) { return new Vector3D([x - x0, y - y0, z - z0]); }
}
